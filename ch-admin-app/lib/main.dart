...
Future<void> main() async {
  ...
  final logger = ErrorLoggingService(
    client: client,
    sourceProject: 'corfu_hub_admin_app',
  );
  ...
  runApp(
    Provider<AppRepository>.value(
      ...
      child: EnvBanner(
        ...
        child: const CorfuHubAdminApp(),
      ),
    ),
  );
}

class CorfuHubAdminApp extends StatelessWidget {
  const CorfuHubAdminApp({super.key});

  @override
  Widget build(BuildContext context) {
    return const MaterialApp(
      title: 'CorfuHub Admin',
      home: Scaffold(
        body: Center(child: Text('Admin App — Coming Soon')),
      ),
    );
  }
}
